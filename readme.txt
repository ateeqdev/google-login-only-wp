...
**WP Social Login** is a security-focused authentication plugin that eliminates WordPress passwords and replaces them with **Google-only authentication**. It provides both **Google Sign-In** and **Google One Tap**, offering users a fast, secure, and frictionless login experience.
...
3. Go to **Social Login** in the WordPress admin sidebar.
