...
?>
        <div class="wpsl-login-container">
            <div class="wpsl-login-header">
                <h2><?php esc_html_e('Welcome Back', 'wp-social-login'); ?></h2>
                <p><?php esc_html_e('Sign in with your Google account to continue.', 'wp-social-login'); ?></p>
            </div>

            <div class="wpsl-login-content">
                <a href="<?php echo esc_url($auth_url); ?>" class="wpsl-google-button" id="google-login-btn">
                    <svg class="wpsl-google-logo" viewBox="0 0 24 24" fill="none">
        ...
        <div class="wpsl-footer">
            <p>
                <?php esc_html_e('Login experience by', 'wp-social-login'); ?>
                <a href="https://hardtoskip.com/" target="_blank" rel="dofollow">
                    <?php esc_html_e('HardToSkip', 'wp-social-login'); ?>
                </a>
                <?php esc_html_e('- Viral Content Generator', 'wp-social-login'); ?>
            </p>
        </div>

        <!-- Loading overlay -->
        <div id="wpsl-auth-loading">
            <div class="wpsl-auth-content">
                <div class="wpsl-spinner"></div>
                <p><?php esc_html_e('Signing you in...', 'wp-social-login'); ?></p>
            </div>
        </div>
<?php
    }
