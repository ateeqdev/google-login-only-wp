...
class ESL_AdminSettings
{
    private $plugin_name;
    private $version;
    private $option_name = 'esl_settings';
    private $wizard_progress_option = 'esl_wizard_progress';
    ...
    public function __construct($plugin_name, $version)
    {
        ...
        add_action('wp_ajax_esl_test_connection', [$this, 'ajaxTestConnection']);
    }
    ...
    public function enqueueAdminAssets($hook)
    {
        ...
        wp_enqueue_style('esl-admin', ESL_PLUGIN_URL . 'assets/css/admin.css', [], $this->version);
        wp_enqueue_script('esl-admin', ESL_PLUGIN_URL . 'assets/js/admin.js', [], $this->version, true);

        $settings = get_option($this->option_name, []);
        $allowed_users = $settings['allowed_users'] ?? [];

        $user_template = '
            <div class="esl-user-item">
            ...
            '</select>
                <button type="button" class="esl-remove-user"><span class="dashicons dashicons-trash"></span></button>
            </div>';

        wp_localize_script('esl-admin', 'esl_admin', [
            'nonce' => wp_create_nonce('esl_admin_nonce'),
...
?>
        <div class="esl-admin-wrap">
            <?php $this->renderHeader(); ?>

            <div class="esl-content-wrapper">
                <div class="esl-main-content">
    ...
    ?>
        <div class="esl-header">
            <div class="esl-header-content">
                <div class="esl-header-icon">
    ...
    ?>
        <div class="esl-progress-container">
            <div class="esl-steps-nav">
                <?php foreach ($steps as $key => $step) : ?>
                    ...
                    ?>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=' . $this->plugin_name . '&step=' . $key)); ?>" class="esl-step-nav <?php echo esc_attr($step_class); ?>">
                        <span class="esl-step-number"><?php echo esc_html($step['number']); ?></span>
                        <span class="esl-step-label"><?php echo esc_html($step['title']); ?></span>
                    </a>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    ?>
        <div class="esl-sidebar-card">
            <h3><?php esc_html_e('Quick Status', 'easy-secure-login'); ?></h3>
            <div class="esl-status-item">
                <span class="esl-status-label"><?php esc_html_e('Configuration:', 'easy-secure-login'); ?></span>
                <span class="esl-status-value <?php echo $is_configured ? 'success' : 'warning'; ?>">
                    <?php echo $is_configured ? esc_html__('Complete', 'easy-secure-login') : esc_html__('Pending', 'easy-secure-login'); ?>
                </span>
            </div>
            <div class="esl-status-item">
                <span class="esl-status-label"><?php esc_html_e('Authorized Users:', 'easy-secure-login'); ?></span>
                <span class="esl-status-value"><?php echo count($settings['allowed_users'] ?? []); ?></span>
            </div>
            <div class="esl-status-item">
                <span class="esl-status-label"><?php esc_html_e('Security Features:', 'easy-secure-login'); ?></span>
                <span class="esl-status-value"><?php echo count(array_filter($settings['security_features'] ?? [])); ?>/5</span>
            </div>
        </div>

        <div class="esl-sidebar-card">
            <h3><?php esc_html_e('Quick Links', 'easy-secure-login'); ?></h3>
            <div class="esl-quick-links">
                <a href="<?php echo esc_url(wp_login_url()); ?>" target="_blank" class="esl-quick-link">
                    <span class="dashicons dashicons-external"></span>
                    <?php esc_html_e('Test Login Page', 'easy-secure-login'); ?>
                </a>
                <a href="https://console.cloud.google.com/apis/credentials" target="_blank" class="esl-quick-link">
                    <span class="dashicons dashicons-cloud"></span>
                    <?php esc_html_e('Google Cloud Console', 'easy-secure-login'); ?>
                </a>
                <a href="https://hardtoskip.com/" target="_blank" class="esl-quick-link">
                    <span class="dashicons dashicons-admin-plugins"></span>
                    <?php esc_html_e('Plugin Creator', 'easy-secure-login'); ?>
                </a>
                <a href="https://linkedin.com/in/ateeqdev" target="_blank" class="esl-quick-link">
    ...
    private function renderOverviewStep($progress)
    {
        ...
        $is_configured = !empty($settings['client_id']) && !empty($settings['client_secret']);
    ?>
        <div class="esl-step-content">
            <div class="esl-step-header">
            ...
            <div class="esl-cards-grid">
                <div class="esl-feature-card">
                    <div class="esl-feature-icon security"><span class="dashicons dashicons-shield-alt"></span></div>
                ...
                <div class="esl-feature-card">
                    <div class="esl-feature-icon user"><span class="dashicons dashicons-admin-users"></span></div>
                ...
                <div class="esl-feature-card">
                    <div class="esl-feature-icon experience"><span class="dashicons dashicons-thumbs-up"></span></div>
            ...
            <div class="esl-step-actions">
                <span></span>
                <a href="<?php echo esc_url(admin_url('admin.php?page=' . $this->plugin_name . '&step=google_api')); ?>" class="esl-btn primary large">
    ...
    ?>
        <div class="esl-step-content">
            ...
            <form method="post" action="options.php" id="esl-google-api-form" class="esl-form">
                <?php settings_fields($this->plugin_name); ?>
                <div class="esl-setup-instructions">
                        ...
                        <li>
                            ...
                            echo wp_kses_post(
                                sprintf(
                                    ...
                                    '<a href="https://console.cloud.google.com/apis/credentials" target="_blank" class="esl-external-link">' . esc_html__('Google Cloud Console', 'easy-secure-login') . ' <span class="dashicons dashicons-external"></span></a>'
                                )
                            );
                            ?>
                        </li>
                ...
                <div class="esl-form-section">
                    <h3><?php esc_html_e('Required URLs for Google Console', 'easy-secure-login'); ?></h3>
                    <div class="esl-url-group">
                        <label for="esl-uri-1"><?php esc_html_e('Authorized redirect URIs (add both)', 'easy-secure-login'); ?></label>
                        <div class="esl-copy-input">
                            <input id="esl-uri-1" type="text" readonly value="<?php echo esc_attr(home_url('?action=google_login_callback')); ?>">
                            <button type="button" class="esl-copy-btn"><?php esc_html_e('Copy', 'easy-secure-login'); ?></button>
                        </div>
                    </div>
                    <div class="esl-url-group">
                        <div class="esl-copy-input">
                    ...
                    <div class="esl-url-group">
                        <label for="esl-origin-1"><?php esc_html_e('Authorized JavaScript origins', 'easy-secure-login'); ?></label>
                        <div class="esl-copy-input">
                            <input id="esl-origin-1" type="text" readonly value="<?php echo esc_attr(home_url()); ?>">
                            <button type="button" class="esl-copy-btn"><?php esc_html_e('Copy', 'easy-secure-login'); ?></button>
                        </div>
                    </div>
                </div>
                ...
                <div class="esl-step-actions">
                    <a href="<?php echo esc_url(admin_url('admin.php?page=' . $this->plugin_name . '&step=overview')); ?>" class="esl-btn secondary"><span class="dashicons dashicons-arrow-left-alt"></span><?php esc_html_e('Back', 'easy-secure-login'); ?></a>
                    <div class="esl-actions-right">
                        <button type="button" id="esl-test-connection-btn" class="esl-btn outline"><?php esc_html_e('Test Connection', 'easy-secure-login'); ?></button>
                        <button type="submit" name="submit" class="esl-btn primary"><?php esc_html_e('Save & Continue', 'easy-secure-login'); ?><span class="dashicons dashicons-arrow-right-alt"></span></button>
                    </div>
                </div>
            </form>
        </div>
    ...
    ?>
        <div class="esl-step-content">
            ...
            <form method="post" action="options.php" class="esl-form">
                <?php settings_fields($this->plugin_name); ?>
                <div class="esl-alert info">
                ...
                <div class="esl-security-grid">
                    ...
                    ?>
                        <div class="esl-security-card <?php echo $is_enabled ? 'enabled' : ''; ?>">
                            <div class="esl-security-header">
                                <div class="esl-security-icon"><span class="dashicons dashicons-<?php echo esc_attr($feature['icon']); ?>"></span></div>
                                <label class="esl-toggle">
                                    <input type="checkbox" name="<?php echo esc_attr($this->option_name); ?>[security_features][<?php echo esc_attr($key); ?>]" value="1" <?php checked($is_enabled); ?> class="esl-toggle-input">
                                    <span class="esl-toggle-slider"></span>
                                </label>
                            </div>
                            <h4><?php echo esc_html($feature['title']); ?></h4>
                            <p class="esl-security-description"><?php echo esc_html($feature['description']); ?></p>
                        </div>
                    <?php endforeach; ?>
                </div>

                <div class="esl-step-actions">
                    <a href="<?php echo esc_url(admin_url('admin.php?page=' . $this->plugin_name . '&step=google_api')); ?>" class="esl-btn secondary"><span class="dashicons dashicons-arrow-left-alt"></span><?php esc_html_e('Back', 'easy-secure-login'); ?></a>
                    <button type="submit" name="submit" class="esl-btn primary"><?php esc_html_e('Save & Continue', 'easy-secure-login'); ?><span class="dashicons dashicons-arrow-right-alt"></span></button>
                </div>
            </form>
        </div>
    ...
    ?>
        <div class="esl-step-content">
            ...
            <form method="post" action="options.php" class="esl-form">
                <?php settings_fields($this->plugin_name); ?>
                <div class="esl-form-section">
                    <div class="esl-section-header">
                        <h3><?php esc_html_e('Authorized Users', 'easy-secure-login'); ?></h3>
                        <button type="button" id="esl-add-user-btn" class="esl-btn outline small"><span class="dashicons dashicons-plus-alt"></span><?php esc_html_e('Add User', 'easy-secure-login'); ?></button>
                    </div>
                    <div class="esl-user-list-header">
                        <label><?php esc_html_e('Email Address', 'easy-secure-login'); ?></label>
                        <label><?php esc_html_e('Role', 'easy-secure-login'); ?></label>
                    </div>
                    <div class="esl-user-list" id="user-list">
                ...
                <div class="esl-form-section">
                    ...
                    <div class="esl-form-group esl-toggle-group">
                        <label class="esl-toggle-label">
                            <input type="checkbox" name="<?php echo esc_attr($this->option_name); ?>[allow_new_signups]" value="1" <?php checked(!empty($settings['allow_new_signups'])); ?> id="esl-allow-signups">
                            <div class="esl-toggle-content">
                                <span class="esl-toggle-title"><?php esc_html_e('Allow New User Sign-Ups', 'easy-secure-login'); ?></span>
                                <p class="esl-toggle-description"><?php esc_html_e('Allow any Google user to create an account. This bypasses the authorized user list above.', 'easy-secure-login'); ?></p>
                            </div>
                        </label>
                    </div>
                    <div class="esl-signup-role-section" id="esl-signup-role-section" style="<?php echo empty($settings['allow_new_signups']) ? 'display: none;' : ''; ?>">
                        <div class="esl-form-group">
                            ...
                            <p class="esl-field-description"><?php esc_html_e('Subscriber is the safest and recommended option for new public registrations.', 'easy-secure-login'); ?></p>
                        </div>
                    </div>
                </div>

                <div class="esl-step-actions">
                    <a href="<?php echo esc_url(admin_url('admin.php?page=' . $this->plugin_name . '&step=security')); ?>" class="esl-btn secondary"><span class="dashicons dashicons-arrow-left-alt"></span><?php esc_html_e('Back', 'easy-secure-login'); ?></a>
                    <button type="submit" name="submit" class="esl-btn primary"><?php esc_html_e('Save & Continue', 'easy-secure-login'); ?><span class="dashicons dashicons-arrow-right-alt"></span></button>
                </div>
            </form>
        </div>
    ...
    ?>
        <div class="esl-step-content">
            ...
            <form method="post" action="options.php" class="esl-form">
                ...
                <div class="esl-form-section">
                    <div class="esl-form-group esl-toggle-group">
                        <label class="esl-toggle-label">
                            ...
                            <div class="esl-toggle-content">
                                <span class="esl-toggle-title"><?php esc_html_e('Enable One Tap on Homepage', 'easy-secure-login'); ?></span>
                                <p class="esl-toggle-description"><?php esc_html_e('Show the One Tap prompt to logged-out visitors on your homepage and other public pages.', 'easy-secure-login'); ?></p>
                            </div>
                        </label>
                    </div>
                </div>
                ...
                <div class="esl-step-actions">
                    <a href="<?php echo esc_url(admin_url('admin.php?page=' . $this->plugin_name . '&step=users')); ?>" class="esl-btn secondary"><span class="dashicons dashicons-arrow-left-alt"></span><?php esc_html_e('Back', 'easy-secure-login'); ?></a>
                    <button type="submit" name="submit" class="esl-btn primary"><?php esc_html_e('Save & Continue', 'easy-secure-login'); ?><span class="dashicons dashicons-arrow-right-alt"></span></button>
                </div>
            </form>
        </div>
    ...
    ?>
        <div class="esl-step-content">
            <div class="esl-completion-header">
                <div class="esl-completion-icon"><span class="dashicons dashicons-yes-alt"></span></div>
            ...
            <div class="esl-alert success large">
                <div class="esl-alert-icon"><span class="dashicons dashicons-shield-alt"></span></div>
                <div class="esl-alert-content">
            ...
            <div class="esl-action-cards">
                <a href="<?php echo esc_url(wp_login_url()); ?>" target="_blank" class="esl-action-card primary">
                    <div class="esl-action-icon"><span class="dashicons dashicons-external"></span></div>
                    <div class="esl-action-content">
                        <h4><?php esc_html_e('Test Login', 'easy-secure-login'); ?></h4>
                        <p><?php esc_html_e('Try the new login experience', 'easy-secure-login'); ?></p>
                    </div>
                </a>
                <a href="<?php echo esc_url(admin_url('users.php')); ?>" class="esl-action-card">
                    <div class="esl-action-icon"><span class="dashicons dashicons-admin-users"></span></div>
                    <div class="esl-action-content">
            ...
            <div class="esl-step-actions">
                <a href="<?php echo esc_url(admin_url('admin.php?page=' . $this->plugin_name . '&step=one_tap')); ?>" class="esl-btn secondary"><span class="dashicons dashicons-arrow-left-alt"></span><?php esc_html_e('Back', 'easy-secure-login'); ?></a>
                <a href="<?php echo esc_url(admin_url('admin.php?page=' . $this->plugin_name . '&step=overview')); ?>" class="esl-btn outline"><?php esc_html_e('Return to Overview', 'easy-secure-login'); ?></a>
            </div>
        </div>
<?php
    }
    ...
    {
        check_ajax_referer('esl_admin_nonce', 'nonce');
